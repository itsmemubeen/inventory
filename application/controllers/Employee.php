...
class Employee extends CI_Controller
{
    ...
    function purchase_add($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', 'A New Purchase Has Been Created');
            redirect(base_url() . 'index.php?employee/purchase_invoice_view/' . $purchase_code, 'refresh');
        }
        $page_data['page_name'] = 'purchase_add';
        $page_data['page_title'] = "Make A New Purchase";
        $this->load->view('backend/index', $page_data);
    }
    ...
    function purchase_invoice_view($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = 'View Purchase Invoice';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function supplier($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', 'A New Supplier Has Been Created');
            redirect(base_url() . 'index.php?employee/supplier', 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name'] = $this->input->post('name');
            $data['company'] = $this->input->post('company');
...
//            }
    ...
    function customer($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message', 'New Customer Has Been Added');
            redirect(base_url() . 'index.php?employee/customer', 'refresh');
        }
        if ($param1 == 'edit') {
            $data['name'] = $this->input->post('name');
            $data['email'] = $this->input->post('email');
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message', 'Customer Has Been Deleted');
            redirect(base_url() . 'index.php?employee/customer', 'refresh');
        }
    ...
    function sale_add($param1 = '')
    {
        ...
        if ($param1 == 'do_add') {
            ...
            $this->session->set_flashdata('flash_message', 'A New Sale Has Been Created');
            redirect(base_url() . 'index.php?employee/sale_invoice_view/' . $invoice_code, 'refresh');
        }
        $page_data['page_name'] = 'sale_add';
        $page_data['page_title'] = 'Make A New Sale';
        $this->load->view('backend/index', $page_data);
    }
    ...
    function sale_payment($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'take_payment') {
            ...
            $this->session->set_flashdata('flash_message', 'Payment Taken Successfully');
            redirect(base_url() . 'index.php?employee/sale_invoice_view/' . $invoice_code, 'refresh');
        }
    }
    ...
    function message($messgae_thread_code = '')
    {
        ...
        $page_data['page_title'] = 'Personal Messages';
    ...
    function profile_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update') {
            ...
            $this->session->set_flashdata('flash_message', 'Profile Information Has Been Updated');
        ...
        if ($param1 == 'change_password') {
            ...
            if ($existing_password == $data['previous_password'] && $data['new_password'] == $data['confirm_password']) {
                ...
                $this->session->set_flashdata('flash_message', 'Password Did Not Match');
            }
            redirect(base_url() . 'index.php?employee/profile_settings', 'refresh');
        }
