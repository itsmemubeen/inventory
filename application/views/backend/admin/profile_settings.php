                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" name="phone" data-parsley-required="true"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9">
                            <textarea class="form-control" name="address" data-parsley-required="true"
                                      placeholder="Your Address"><?php echo $this->db->get_where($logged_in_user_type, array(
                                    $logged_in_user_type . '_id' => $logged_in_user_id
