                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            ...
                            <h4 class="box-title"><?php echo 'Invoice Code' . ': ' . $row['invoice_code']; ?></h4>
                        </div>
                        <div class="box-body">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-info">
                        <div class="box-header">
                            ...
                            <h4 class="box-title">Receive Payment</h4>
                        </div>
                        <div class="box-body">
                            <?php
                            echo form_open(base_url() . 'index.php?admin/sale_payment/take_payment/' . $row['invoice_id'], array(
