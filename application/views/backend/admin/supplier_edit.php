...
<?php 
    echo form_open(base_url() . 'index.php?admin/getSuppliers/edit/' . $row['supplier_id'] , array(
...
?>
	...
	<div class="form-group">
		...
		<div class="col-md-6 col-sm-6">
			<input classtranslate="form-control" type="text" name="company"
				placeholder="Supplier Company" value="<?php echo $row['company'];?>" />
		</div>
	</div>
    ...
    <div class="form-group">
		...
		<div class="col-md-6 col-sm-6">
			<input class="form-control" type="text" name="phone"
				placeholder="Supplier Phone Number" value="<?php echo $row['phone'];?>" />
		</div>
	</div>
