                            ...
                            foreach ($messages as $row):
                                ...
                                <li class="list-group-item default">
                                    ...
                                    <div class="email-info">
                                        <span
                                            class="email-time"><strong><?php echo date("d M, Y", $row['timestamp']); ?></strong></span>
                                        <h5 class="email-title">
                                            <strong><?php echo $this->db->get_where($sender_account_type, array($sender_account_type . '_id' => $sender_id))->row()->name; ?></strong>
                                        </h5>
                                        <hr>
                                        <p class="email-desc">
