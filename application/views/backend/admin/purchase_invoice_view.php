                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6">
                                    <div class="invoice-to">
                                        <small>To</small>
                                        <address class="m-t-5 m-b-5">
                                            <strong><?php echo $this->db->get_where('vendors', array('id' => $row['supplier_id']))->row()->name; ?></strong><br/>
                                            <!-- <?php echo $this->db->get_where('vendor', array('id' => $row['supplier_id']))->row()->name; ?>
                                            <br/>
                                            Phone
                                            : <?php echo $this->db->get_where('vendor', array('id' => $row['supplier_id']))->row()->phone; ?>
                                            <br/>
                                            Email
                                            : <?php echo $this->db->get_where('vendor', array('id' => $row['supplier_id']))->row()->email; ?> -->
                                        </address>
                                    </div>
                                </div>
                            </div>
