...
<div class="content-wrapper">
    ...
    <section class="content">
        <?php
        echo form_open(base_url() . 'index.php?admin/add_a_new_sale/do_add/', array(
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9">
                                    <input class="form-control" type="text" name="invoice_code"
            ...
            <div class="col-md-3">
                ...
                <div class="box box-warning">
                    <div class="box-header">
                        ...
                        <h4 class="box-title">Select Product Category</h4>
                    </div>
                    <div class="box-body">

                        <div class="form-group">
                            <div class="col-md-12 col-sm-12">
                                <select onchange="get_product('category' , this.value)"
                                        class="form-control selectpicker" data-size="10" data-live-search="true"
                                        data-style="btn-default" name="category_id">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <h4 class="box-title">Click On The Product To Add For Sale</h4>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        ...
                        <h4 class="panel-title">Select A Product To Sale</h4>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>Payment</td>
                                        <td>
                                            <input class="form-control text-right" type="text" name="" id="payment"
                                                   value=""
                                ...
                                <div class="form-group col-md-10">
                                    <button type="submit"
                                            class="btn btn-success">Make A Sale
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    function remove_row(entry_number) {
        ...
        for (var i = entry_number; i < total_number; i++) {
            ...
            $("#single_entry_quantity_" + (i )).attr({
                onkeyup: "calculate_single_entry_total(" + i + ")",
                onclick: "calculate_single_entry_total(" + i + ")"
            });
