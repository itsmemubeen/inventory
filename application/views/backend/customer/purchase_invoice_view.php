<?php
$purchase_invoice_details = $this->db->get_where('invoice', array(
                ...
                <div class="invoice-date">
                    ...
                    <div class="invoice-detail">
                        ...
                        <?php if ($payment_method == 3): ?>
                            <strong>Payment Method: Card</strong>
                        <?php endif; ?>
                    </div>
                </div>
                <hr>
                        ...
                        <div class="invoice-price-row">
                            <div class="sub-price">
                                ...
                                <?php echo $currency . ' ' . $row['sub_total']; ?> <i
                                    class="fa fa-plus"></i> <?php echo $row['vat_percentage']; ?>
                                % VAT <i class="fa fa-minus"></i> <?php echo $row['discount_percentage']; ?> % Discount
                            </div>
                            <div class="sub-price">
