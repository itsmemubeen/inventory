                    ...
                    <div class="invoice-header">
                        ...
                        <div class="invoice-to">
                            ...
                            <address class="m-t-5 m-b-5">
                                ...
                                <br/>
                                Phone: <?php echo $this->db->get_where('supplier', array('supplier_id' => $row['supplier_id']))->row()->phone; ?>
                                <br/>
                                Email: <?php echo $this->db->get_where('supplier', array('supplier_id' => $row['supplier_id']))->row()->email; ?>
                            </address>
                        </div>
                        <div class="invoice-date">
                            <div class="date m-t-5"><?php echo date('dS M, Y', $row['timestamp']); ?></div>
                            <div class="invoice-detail">
                                <strong>Purchase Code: <?php echo $row['purchase_code']; ?></strong>
                            </div>
                        </div>
                    </div>
                    <div class="invoice-content">
                        ...
                        <div class="invoice-price">
                            ...
                            <div class="invoice-price-right">
                                ...
                                <?php echo $currency . ' ' . $this->db->get_where('payment', array('purchase_id' => $row['purchase_id']))->row()->amount; ?>
                            </div>
                        </div>
                    </div>
